    ...
    return (
        <div
            className={`xs:text-xs xs:mx-1 my-2 xs:w-full  xs:h-[250px] md:h-[350px]
                md:mx-2 flex justify-between flex-col border-1 hover:border-black hover:shadow-lg hover:scale-105 transition-all duration-300 p-2 relative font-medium`}>
